...
public class ListarUsuarios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        javax.swing.JTextArea taUsuarios = new javax.swing.JTextArea();
        ...
        lTemp.setText("Temp");
        lTemp.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lTempMouseClicked(evt);
            }
        });
    ...
    private void lTempMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lTempMouseClicked
        this.taUsuarios.setText("Poner algo en el TextArea");
    }//GEN-LAST:event_lTempMouseClicked
